...
INICIO	  
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ;;;;;;;;;;;BOTONES;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    BTFSC PORTB, 0  ;se pregunta si hay un cero en la posicion 0 del portB
    CALL BTN1     ; si hay un uno en la posicion del protb se orpime el BTN1
    BTFSC PORTB, 1  ;
    CALL BTN2
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   ...
   BTFSS STATUS,Z ;pregunta si z esta prendido solo puede estar prendido cuando da 0
   GOTO continua
   GOTO prendeled1
   GOTO INICIO
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
MAYOR
 ...
 MENOR
   ...
   MOVLW b'111100'  ; signo de menor en aski
   MOVWF PORTD
   CALL exec   
   RETURN
